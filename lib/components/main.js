...
export default class Main extends React.Component {
  ...
  toggleTree(e) {
    e.preventDefault();
    this.setState(prev => ({
      mainSectionWidth: prev.mainSectionWidth === "73%" ? "99%" : "73%",
      treeWidth: prev.treeWidth === "27%" ? "1%" : "27%",
  ...
  toggleTop(e) {
    e.preventDefault();
    this.setState(prev => ({
      topHeight: prev.topHeight === "17%" ? "1" : "17%",
      boardHeight: prev.boardHeight === "83%" ? "99%" : "83%",
  ...
  render() {
    return (
      <StyledMain mainSectionWidth={this.state.mainSectionWidth} treeWidth={this.state.treeWidth}
                  boardHeight={this.state.boardHeight} topHeight={this.state.topHeight}>

        <Top toggleTop={this.toggleTop} visible={this.state.topVisible}
           workingset={this.state.workingset} currentBoard={this.currentBoard} toggleWorkingSet={this.toggleWorkingSet}
