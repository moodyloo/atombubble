...
export default class Tree extends React.Component {
    ...
    if (toggle) {
      ...
      var fileNames = objectsarray.map((x)=>{
        ...
        var subfunctions = x.body.map((func)=>{
          ...
          if (func.type === "FunctionDeclaration") { //only function declarations
            return(
  ...
  render() {
    return (
      <StyledTree onContextMenu={(e)=>{this.props.toggleTree(e)}}>
        <div className="icon icon-book" onClick={(e)=>{this.props.saveFile(e)}}>Save Bubble Project</div>
